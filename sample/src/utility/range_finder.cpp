...
#include <iostream>
range_finder::range_finder(std::array<float, 3> from_points, std::array<float, 3> to_points, worldComposite* world, btRigidBody* attachedBody)
	:m_from_points{ from_points }, m_to_points{to_points}, m_world{world}, m_attachedBody{ attachedBody }
{
